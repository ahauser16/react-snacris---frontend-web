    ...
    return (
      <div className="card mb-3 shadow-sm w-100">
        <div
          ...
          aria-label="Reference data not available"
        >
  ...
  if (!remarksRecords || remarksRecords.length === 0) {
    return (
      <div className="card mb-3 shadow-sm w-100">
        <div
          className="card-body notApplic"
          aria-label="Remarks data not available"
        >
...
function RealPropertyCardContainer({
  ...
  return (
    <div className="card mb-3 shadow-sm w-100 p-1">
      <h4 className="card-header text-primary mb-1">Document ID: {docId}</h4>
      <div className="mb-3">
        <a
          href={detailUrl}
          target="_blank"
      ...
      <div className="d-flex flex-column gap-3">
        <div>
          {group.masterRecords?.length > 0 ? (
            ...
            <div className="card mb-3 shadow-sm w-100">
              <div
                className="card-body notApplic"
                aria-label="Master data not available"
              >
        ...
        <PartiesCardSelector
          // support both keys in case backend uses partiesRecords
          partiesRecords={group.partyRecords || group.partiesRecords || []}
          docType={docType}
        />
      </div>
