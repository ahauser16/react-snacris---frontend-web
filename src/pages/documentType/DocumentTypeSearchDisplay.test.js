/**
 * Test suite for DocumentTypeSearchDisplay component
 *
...
describe("DocumentTypeSearchDisplay Component", () => {
  // Sample test data
  const singleResult = [
    {
  ...
  test("displays 'No results found' message when results are empty", () => {
    render(<DocumentTypeSearchDisplay results={[]} />);
  ...
  test("displays 'No results found' message when results are null", () => {
    render(<DocumentTypeSearchDisplay results={null} />);
  ...
  test("renders correctly with a single result", () => {
    render(<DocumentTypeSearchDisplay results={singleResult} />);
  ...
  test("renders correctly with multiple results and allows selection", () => {
    render(<DocumentTypeSearchDisplay results={multipleResults} />);
  ...
  test("renders correctly with a result that has no record data", () => {
    render(<DocumentTypeSearchDisplay results={emptyRecordsResult} />);
